...
if (sqlsrv_execute($stmt_laporan)) {
    if (sqlsrv_has_rows($stmt_laporan)) {
        ...
        echo '<table border="1" cellpadding="10" cellspacing="0" style="width: 100%; margin: 0px 0px;">';
        ...
        while ($row = sqlsrv_fetch_array($stmt_laporan, SQLSRV_FETCH_ASSOC)) {
            echo '<tr>';
            echo '<td style="font-size: 12px; text-align:center;">' . htmlspecialchars($row['laporan_id']) . '</td>';
            ...
            echo '<td style="font-size: 12px; text-align:center;">' . htmlspecialchars($row['prodi']) . '</td>';
            echo '<td style="font-size: 12px; text-align:center;">' . htmlspecialchars($row['kelas']) . '</td>';
            echo '<td style="font-size: 12px;">' . htmlspecialchars($row['deskripsi_pelanggaran']) . '</td>';
