...
<!--Warna side bar-->
<div class="sidebar" style="background: linear-gradient(160deg, rgb(227, 221, 255), rgb(2, 10, 125)); color: #696161; width: 200px; margin-top: 60px;  height: 200%; z-index: 1000;">
<!--   /warna side bar-->
