...
<body>
    ...
    <p><a href="dosen_dashboard.php?page=cek_laporan" class="btn-back">Kembali ke Daftar Laporan</a></p>
    ...
    <table class="detail-table">
        ...
        <tr>
            ...
            <td><?= $laporan_detail['status_verifikasi'] ? 'Terverifikasi' : 'Belum Diverifikasi'; ?></td>
        </tr>
        <tr>
            <th>Tanggal Verifikasi</th>
            <td><?= $laporan_detail['tgl_verifikasi'] ? htmlspecialchars($laporan_detail['tgl_verifikasi']->format('Y-m-d')) : '-'; ?></td>
        </tr>
    </table>
</div>
